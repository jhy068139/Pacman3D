...
{
    public float soundFxVolume=0.1f;
    public AudioClip soundExplosion; //재생할 소리를 변수로 담습니다.
    public AudioClip soundLifeUp; //재생할 소리를 변수로 담습니다.
    public AudioClip soundSpeedUp; //재생할 소리를 변수로 담습니다.
    ...
    {
        myAudio.volume = soundFxVolume;

        myAudio.PlayOneShot(soundExplosion); //soundExplosion을 재생합니다.
        myAudio.volume = 0.5f;
    }
    public void life_sound()
    {
        myAudio.volume = soundFxVolume;

        myAudio.PlayOneShot(soundLifeUp); //soundExplosion을 재생합니다.
        myAudio.volume = 1f;
    }
    public void speed_sound()
    {
        ...
        myAudio.PlayOneShot(soundSpeedUp); //soundExplosion을 재생합니다.
        myAudio.volume = 1f;
    }
